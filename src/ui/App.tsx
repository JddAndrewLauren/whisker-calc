    ...
    <main>
      ...
      <footer className="muted">
        <p>
          ...
          day; Miners and Heavy Eaters take one more. Food quality stars come from the game's meal table. Water Pump and Steam Boiler rates are estimates, editable in overrides.json.
